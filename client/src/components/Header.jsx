import { HiOutlineBolt, HiOutlineClock, HiOutlineCheckCircle, HiOutlineExclamationTriangle, HiOutlineArrowRightOnRectangle, HiOutlineSun, HiOutlineMoon, HiOutlineUserCircle } from 'react-icons/hi2';

export default function Header({ stats, user, onLogout, theme, toggleTheme, onSignIn }) {
  const statItems = [
    ...
    <header style={{ paddingTop: '40px', paddingBottom: '32px' }}>
      <div className="container">
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '28px', flexWrap: 'wrap', gap: '16px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', background: 'var(--bg-glass)', padding: '8px 16px', borderRadius: '12px', border: '1px solid var(--border-glass)' }}>
            ...
            {user ? (
              ...
              <button
                ...
                onMouseOver={(e) => e.currentTarget.style.boxShadow = '0 4px 20px rgba(129, 140, 248, 0.5)'}
                onMouseOut={(e) => e.currentTarget.style.boxShadow = '0 2px 12px rgba(129, 140, 248, 0.3)'}
              >
